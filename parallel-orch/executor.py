...
def async_run_and_trace_command_return_trace(command, node_id, latest_env_file, speculate_mode=False):
    ...
    process = async_run_and_trace_command_return_trace_in_sandbox(command, trace_file, node_id, stdout_file, stderr_file, latest_env_file, riker_env_file, speculate_mode)
    return process, trace_file, stdout_file, stderr_file, riker_env_file

def async_run_and_trace_command_return_trace_in_sandbox_speculate(command, node_id, latest_env_file):
    process, trace_file, stdout_file, stderr_file, riker_env_file = async_run_and_trace_command_return_trace(command, node_id, latest_env_file, speculate_mode=True)
    return process, trace_file, stdout_file, stderr_file, riker_env_file

def async_run_and_trace_command_return_trace_in_sandbox(command, trace_file, node_id, stdout_file, stderr_file, latest_env_file, riker_env_file, speculate_mode=False):
