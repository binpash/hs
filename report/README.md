...
| `hs_internal_log` | stdout/stderr of hs's internal tooling (`try`, `fstrace`, tracebacks) |
| `strace_log`, `fstrace_trace`, `fstrace_deps`, `fstrace_missed` | tracing artifacts |
...
| `--internal-log` | stdout/stderr of `try`, `fstrace`, Python tracebacks |
