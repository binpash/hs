...
$try -y # Count lines in chr20.bed and chr20_flank500.bed
$try -y echo "Line counts:"
$try -y wc -l chr20.bed chr20_flank500.bed

$try -y # Sort ATF3_chr20.bed file
$try -y echo "Sorting ATF3_chr20.bed..."
$try -y cat ATF3_chr20.bed | $try -y bedtools sort -i > ATF3_chr20_sorted.bed

$try -y # Intersect ATF3 binding sites with promoter regions for chromosome 20
...
$try -y # Repeat sorting and intersecting for chromosome 19
